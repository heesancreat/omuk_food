...
public class secondys extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.secondys);

        imageView = findViewById(R.id.ysgif);

        Glide.with(this).load(R.raw.ys).into(imageView);
        ImageButton imageButton = (ImageButton) findViewById(R.id.ysgif);
        imageButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent img = new Intent(getApplicationContext(),second_random_ys.class);
                startActivity(img);
            }
        });
