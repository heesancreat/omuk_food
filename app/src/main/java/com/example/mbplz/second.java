...
public class second extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //gif 불러오기
        imageView = findViewById(R.id.hsssgif);

        Glide.with(this).load(R.raw.hss).into(imageView);
        ImageButton imageButton = (ImageButton) findViewById(R.id.hsssgif);
        //gif누르면 추천해주는 레이아웃 보여주기
        imageButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent img = new Intent(getApplicationContext(),second_random_hs.class);
                startActivity(img);
            }
        });
